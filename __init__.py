    ...
    def INPUT_TYPES(cls):
        return {
            ...
            "optional": {
                ...
                "prev_params": ("SOX_PARAMS",),
                "enable_x_pixels": ("BOOLEAN", {"default": False, "tooltip": "Enable -x: X-axis size in pixels; default derived or 800"}),
                "---- Window Size ----": ("STRING", {"default": "",
                                                     "tooltip": "Options for Spectrogram window size."}),
                "x_pixels": ("INT", {"default": 800, "min": 100, "max": 200000, "step": 10, "tooltip": "X-axis size in pixels; default derived or 800"}),
                "enable_y_pixels": ("BOOLEAN", {"default": False, "tooltip": "Enable -y: Y-axis size in pixels (per channel); slow if not 1 + 2^n"}),
                "y_pixels": ("INT", {"default": 257, "min": 50, "max": 2000, "step": 1, "tooltip": "Y-axis size in pixels (per channel); slow if not 1 + 2^n"}),
                "enable_Y_height": ("BOOLEAN", {"default": False, "tooltip": "Enable -Y: Y-height total (i.e. not per channel); default 550"}),
                "Y_height": ("INT", {"default": 550, "min": 100, "max": 2000, "tooltip": "Y-height total (i.e. not per channel); default 550"}),
                "enable_z_range": ("BOOLEAN", {"default": False, "tooltip": "Enable -z: Z-axis range in dB; default 120"}),
                "z_range": ("INT", {"default": 120, "min": 20, "max": 180, "tooltip": "Z-axis range in dB; default 120"}),
                "enable_q_quant": ("BOOLEAN", {"default": True, "tooltip": "Enable -q: Z-axis quantisation (0 - 249); default 249"}),
                "q_quant": ("INT", {"default": 249, "min": 2, "max": 256, "tooltip": "Z-axis quantisation (0 - 249); default 249"}),
                ...
                "enable_window_type": ("BOOLEAN", {"default": True, "tooltip": "Enable -w: Window: Hann(default)/Hamming/Bartlett/Rectangular/Kaiser/Dolph"}),
                "window_type": (["hann", "hamming", "bartlett", "rectangular", "kaiser", "dolph"], {"default": "hann", "tooltip": "Window: Hann(default)/Hamming/Bartlett/Rectangular/Kaiser/Dolph"}),
                "window_adj": ("FLOAT", {"default": 0.0, "min": -10.0, "max": 10.0, "step": 0.1, "tooltip": "Window adjust parameter (-10 - 10); applies only to Kaiser/Dolph"}),
                "enable_window_adj": ("BOOLEAN", {"default": True, "tooltip": "Enable -W: Window adjust parameter (-10 - 10); applies only to Kaiser/Dolph"}),
                ...
                "png_prefix": ("STRING", {"default": "", "tooltip": "Output file name; default `spectrogram.png' (-o)"}),
            }
        }
...
class SoxVoiceChipmunkChildNode:
    @classmethod
    def INPUT_TYPES(cls):
        return {
            "required": {
...
class SoxVoiceCompandRobotNode:
    @classmethod
    def INPUT_TYPES(cls):
        return {
            "required": {
...
Applied pre-SR resample, post-input; feeds auto_vol_balance."""}),
            ...
            "characterize_tracks": ("BOOLEAN", {"default": False, "tooltip": "Automatically characterize tracks for ideal mix in rms_power and max_amplitude mixing modes"}),
            ...
            "−−− Track Padding-Filling-Cutting −−−": ("STRING", {"default": "", "tooltip": "Auto volume balance group"}),
...
NODE_CLASS_MAPPINGS = {
    ...
    "SoxVoiceDeepOldMan": SoxVoiceDeepOldManNode,
    "SoxVoiceChipmunkChild": SoxVoiceChipmunkChildNode,
    "SoxVoiceHelium": SoxVoiceHeliumNode,
    "SoxVoiceRobot": SoxVoiceRobotNode,
    "SoxVoiceAlien": SoxVoiceAlienNode,
    "SoxVoiceGhost": SoxVoiceGhostNode,
    "SoxVoiceEchoCave": SoxVoiceEchoCaveNode,
    "SoxVoiceTelephone": SoxVoiceTelephoneNode,
    "SoxVoiceMonster": SoxVoiceMonsterNode,
    "SoxVoiceCompandRobot": SoxVoiceCompandRobotNode,
    "SoxVoiceBoomyDemon": SoxVoiceBoomyDemonNode,
    "SoxVoiceWitch": SoxVoiceWitchNode,
    "SoxVoiceWarble": SoxVoiceWarbleNode,
    "SoxVoiceTemple": SoxVoiceTempleNode,
    "SoxVoiceSquirrel": SoxVoiceSquirrelNode,
    "SoxVoiceGiant": SoxVoiceGiantNode,
    "SoxVoiceVibrato": SoxVoiceVibratoNode,
    "SoxVoiceEvilDemon": SoxVoiceEvilDemonNode,
    "SoxVoiceCartoonDuck": SoxVoiceCartoonDuckNode,
    "SoxVoiceDarthVader": SoxVoiceDarthVaderNode,
    "SoxVoiceChipmunk": SoxVoiceChipmunkNode,
    "SoxVoiceOldWitch": SoxVoiceOldWitchNode,
    "SoxVoiceMinion": SoxVoiceMinionNode,
    "SoxVoiceTerminator": SoxVoiceTerminatorNode,
    "SoxVoiceFairy": SoxVoiceFairyNode,
    "SoxVoiceZombie": SoxVoiceZombieNode,
    "SoxVoicePirate": SoxVoicePirateNode,
    "SoxVoiceSuperhero": SoxVoiceSuperheroNode,
    "SoxUtilTextMux10": SoxUtilTextMux10,
    "SoxUtilTextMux5": SoxUtilTextMux5,
    "SoxUtilAudioMux5": SoxUtilAudioMux5,
    "SoxUtilAudioMuxPro5": SoxUtilAudioMuxPro5,
    "SoxUtilAudioSpli5": SoxUtilAudioSpli5,
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "SoxVoiceDeepOldMan": "Voice: Deep/Old Man",
    "SoxVoiceChipmunkChild": "Voice: Chipmunk/Child",
    "SoxVoiceHelium": "Voice: Helium",
    "SoxVoiceRobot": "Voice: Robot",
    "SoxVoiceAlien": "Voice: Alien",
    "SoxVoiceGhost": "Voice: Ghost",
    "SoxVoiceEchoCave": "Voice: Echo Cave",
    "SoxVoiceTelephone": "Voice: Telephone",
    "SoxVoiceMonster": "Voice: Monster",
    "SoxVoiceCompandRobot": "Voice: Compand Robot",
    "SoxVoiceBoomyDemon": "Voice: Boomy Demon",
    "SoxVoiceWitch": "Voice: Witch",
    "SoxVoiceWarble": "Voice: Warble",
    "SoxVoiceTemple": "Voice: Temple Reverb",
    "SoxVoiceSquirrel": "Voice: Squirrel",
    "SoxVoiceGiant": "Voice: Giant",
    "SoxVoiceVibrato": "Voice: Vibrato",
    "SoxVoiceEvilDemon": "Voice: Evil Demon",
    "SoxVoiceCartoonDuck": "Voice: Cartoon Duck",
    "SoxVoiceDarthVader": "Voice: Darth Vader",
    "SoxVoiceChipmunk": "Voice: Chipmunk",
    "SoxVoiceOldWitch": "Voice: Old Witch",
    "SoxVoiceMinion": "Voice: Minion",
    "SoxVoiceTerminator": "Voice: Terminator",
    "SoxVoiceFairy": "Voice: Fairy",
    "SoxVoiceZombie": "Voice: Zombie",
    "SoxVoicePirate": "Voice: Pirate",
    "SoxVoiceSuperhero": "Voice: Superhero Echo",
    ...
    "SoxUtilAudioSpli5": "SoX Util Audio Split 5",
